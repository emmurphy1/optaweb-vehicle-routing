...
[id="download-vrp-archive-proc_{context}"]
...
ifdef::PRODUCTIZED[]
[id="download-vrp-deployment-files-proc_{context}"]
...
[id="run-vrp-locally-proc_{context}"]
...
NOTE: The `runLocally.sh` script does not run on macOS. If you cannot use the `runLocally.sh` script, see xref:configure-vrp-manually-proc_{context}[].
...
* xref:run-vrp-quickstart-proc_{context}[]
* xref:run-vrp-interactive-proc_{context}[]
* xref:run-vrp-non-interactive-proc_{context}[]
* xref:run-vrp-distance-proc_{context}[]

[id="run-vrp-quickstart-proc_{context}"]
...
[id="run-vrp-interactive-proc_{context}"]
...
[id="run-vrp-non-interactive-proc_{context}"]
...
* The OSM file for the region that you want to use has been downloaded. For information about downloading OSM files, see xref:run-vrp-interactive-proc_{context}[].
* Internet access is available.
...
[id="run-vrp-distance-proc_{context}"]
...
[id="update-data-directory-proc_{context}"]
...
[id="configure-vrp-manually-proc_{context}"]
...
//.Next steps
//xref:use-vrp-con_{context}[]
[id="run-vrp-on-openshift-proc_{context}"]
...
[id="update-vrp-with-local-changes-proc_{context}"]
...
[id="creating-route-proc_{context}"]
=== Creating a route
...
[id="setting-vrp-details-proc_{context}"]
...
[id="vrp-creating-custom-datases-proc_{context}"]
...
[id="trouble-shooting-vrp-proc_{context}"]
...
[id="vrp-developement-guide-con_{context}"]
== OptaWeb Vehicle Routing development guide
You can configure and run the back and front end modules in development mode.
...
[id="running-vrp-backend-proc_{context}"]
...
* OptaWeb Vehicle Routing has been configured as described in xref:configure-vrp-manually-proc_{context}[].
...
[id="running-vrp-backend-intellij-proc_{context}"]
...
[id=spring-boot-auto-restart-con_{context}"]
...
Spring Boot automatic restart is provided by Spring Boot DevTools. When you run the OptaWeb Vehicle Routing back end with the Spring Boot Maven plug-in, the application automatically restarts whenever files on the classpath change.
...
[id="setting-vrp-backend-properties-proc_{context}"]
...
For a complete list of OptaWeb Vehicle Routing configuration properties, see xref:vrp-backend-properties-ref_{context}[].
...
[id="backend-architechure-con_{context}"]
...
[id="vrp-code-organization-con_{context}"]
=== Code organization
...
[id="vrp-backend-properties-ref_{context}"]
